...
export function Header() {
    ...
    return (
        <header className="relative sticky top-0 z-50 overflow-hidden bg-brand-900/95 text-on-dark shadow-soft backdrop-blur">
            <span
                aria-hidden
                className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(66,198,193,0.18),transparent_60%)]"
            />
            <span
                aria-hidden
                className="absolute inset-0 -z-20 bg-[linear-gradient(90deg,rgba(2,18,41,0.95)0%,rgba(3,32,72,0.88)50%,rgba(2,18,41,0.95)100%)]"
            />
